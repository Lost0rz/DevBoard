...
func render(cfg Config) string {
	...
	b.WriteString("  timezone: " + q(cfg.Server.Timezone) + "\n")
	b.WriteString("host:\n")
	...
	b.WriteString("  pad_path: " + q(cfg.Display.PadPath) + "\n")
	b.WriteString("  kindle_right_path: " + q(cfg.Display.KindleRightPath) + "\n")
	b.WriteString("  kindle_left_path: " + q(cfg.Display.KindleLeftPath) + "\n")
	b.WriteString("agent:\n")
	...
	b.WriteString("  password_file: " + q(cfg.Admin.PasswordFile) + "\n")
	...
	b.WriteString("agent_quota:\n")
	b.WriteString("  enabled: " + strconv.FormatBool(cfg.AgentQuota.Enabled) + "\n")
	b.WriteString("  provider: " + q(cfg.AgentQuota.Provider) + "\n")
	b.WriteString("  endpoint: " + q(cfg.AgentQuota.Endpoint) + "\n")
	b.WriteString("  model: " + q(cfg.AgentQuota.Model) + "\n")
	b.WriteString("  schedules: " + q(strings.Join(cfg.AgentQuota.Schedules, ",")) + "\n")
	return b.String()
}
